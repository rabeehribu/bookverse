...
class PubAddBooks extends StatefulWidget {
  const PubAddBooks({super.key});

  @override
  _PubAddBooksState createState() => _PubAddBooksState();
}

class _PubAddBooksState extends State<PubAddBooks> {
  String selectedCategory = 'Novel'; // Default to Novel
  final libraryBooks = FirebaseFirestore.instance.collection('publications');

  @override
  Widget build(BuildContext context) {
    return Consumer<PublicationAuthenticationProvider>(
