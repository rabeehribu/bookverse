...
class UserLibraryDetail extends StatelessWidget {
  ...
  const UserLibraryDetail({super.key, required this.img, required this.title});
                              ...
                              child: GridView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return InkWell(onTap: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => BooksDetail(img:allBooks[index]['image']),));
                                  },
                                    child: Card(
                                      elevation: 5,
                                      child: Container(
