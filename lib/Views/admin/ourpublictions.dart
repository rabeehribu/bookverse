...
import 'our pub details.dart';
import 'ourlibrarydetails.dart';

class OurPublictions extends StatelessWidget {
  OurPublictions({super.key});
              ...
              itemBuilder: (BuildContext context, int index) {
                return Padding(
                    ...
                    child: Card(
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => OurPubDetails(name: librarys[index]['name'], phone: librarys[index]['phone'],),));
                        },
                        child: Container(
