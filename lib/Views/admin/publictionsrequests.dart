import 'package:bookverse/Views/admin/pub%20accept%20or%20not.dart';
...
class PublictionsRequests extends StatelessWidget {
  PublictionsRequests({super.key});

  @override
  List<Map<String, dynamic>> librarys = [
    {'name': 'DC BOOKS', 'Location': 'Calicut'},
    {'name': 'DC BOOKS', 'Location': 'Palakkad'},
    {'name': 'DC BOOKS', 'Location': 'Malappuram'},
              ...
              itemBuilder: (BuildContext context, int index) {
                return Padding(
                    ...
                    child: Card(
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => PublicationsAcceptorNot(name: librarys[index]['name'], phone: librarys[index]['phone'],),));
                        },
                        child: Container(
