...
class PublictionRequests extends StatelessWidget {
  PublictionRequests({Key? key}) : super(key: key);
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => PublicationsAcceptorNot(
                                    name: libraryData['publicationName'],
                                    location: libraryData['location'],
                                    phone: libraryData[
                                    'phoneNum'],
                                    email: libraryData[
                                    'email'],
                                    image: libraryData['publicationImg'],
